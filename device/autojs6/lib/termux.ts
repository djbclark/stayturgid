...
import termuxConfig = require("./config.js");
import termuxLog = require("./log.js");
import termuxShizukuShell = require("./shizuku_shell.js");
...
export function tryRunCommand(): RunCommandOutcome {
  try {
