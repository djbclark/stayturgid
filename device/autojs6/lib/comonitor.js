 ...
 */
const comonitorConfig = require("./config.js");
const comonitorLog = require("./log.js");
const comonitorNotify = require("./notify.js");
const comonitorShizukuShell = require("./shizuku_shell.js");
const comonitorRepair = require("./repair.js");
...
function run(profile, opts) {
  ...
  if (
    ...
    !comonitorLog.isRepairLoopStale() &&
    !comonitorConfig.splitStorage(resolvedProfile)
  ) {
