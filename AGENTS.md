...
| `just lint`                         | All linters: shellcheck, ansible-lint (incl. examples), yamllint (incl. examples), ruff, typos, biome, shfmt, justfile fmt, markdownlint, prettier, dotenv-linter, caddy-fmt, pyinilint |
