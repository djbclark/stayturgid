...
| `just web-health`                   | Full web audit: html-validate + lychee + lighthouse + pa11y + puppeteer + hint (requires :4097)                                                                                                                                             |
...
| `just hint`                         | WebHint best-practices audit on running dashboard (Node <=25 only)                                                                                                                                                                          |
...
| `just lint`                         | All linters: shellcheck, ansible-lint (incl. examples), yamllint (incl. examples), ruff, typos, biome, shfmt, justfile fmt, markdownlint, prettier, dotenv-linter, caddy-fmt, pyinilint, html-validate, stylelint, lychee, pa11y, puppeteer |
