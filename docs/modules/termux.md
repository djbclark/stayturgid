...
| Piece | Role |
|-------|------|
| `stayturgid_repair.py` | Self-heal sshd, localhost:5555 ADB, Shizuku; prints `STATUS …` for callers |
...
- [docs/incubator/on-device-llm.md](../incubator/on-device-llm.md) — optional shell-gpt escalation (not hot-path)
