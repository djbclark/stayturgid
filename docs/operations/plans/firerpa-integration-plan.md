...
2. **Update documentation:**
   ...
   - `docs/operations/plans/firerpa-integration-plan.md` — mark all steps complete
   - `docs/research/evaluations/firerpa-lamda-analysis-2026-07-10.md` — cross-reference
   - `docs/research/experiments/tablet-control-phone.md` — update with FIRERPA findings
