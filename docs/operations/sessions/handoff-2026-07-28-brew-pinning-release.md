...
**Deliberately not touched**: the rest of the open issue backlog (#41-66, #82,
#86, #100, etc.) — those are already assigned to specific agents later in the
`~/ai-orchestration-plan-2026-07-28.md` roster (different models, by design,
