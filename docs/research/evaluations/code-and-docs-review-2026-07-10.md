...
| `docs/hacking.md`                          | `docs/architecture/components/…`; nonexistent collection module paths |
| `docs/architecture/multi-site-topology.md` | `docs/…`, `examples/…`                                                |
| `docs/architecture/components/control.md`  | `../docs/…` / wrong depth to `control/`                               |
| `docs/architecture/vlm.md`                 | `docs/hacking.md` → `docs/docs/hacking.md`                            |
...
| `docs/architecture/core-architecture.md` | Flat shims **removed**                                 |
...
| Cloud VLM              | **Strong** — `docs/architecture/vlm.md`       |
...
- Local + cloud VLM gates (architecture note removed with VLM retirement on
  2026-07-26)
