...
- `~/stayturgid/docs/modules/control.md`
  <https://github.com/djbclark/stayturgid/blob/master/docs/modules/control.md>
...
- Planned Make-to-`just` migration:
  <https://github.com/djbclark/stayturgid/blob/master/docs/plans/just-migration-plan.md>
- Ordered outstanding-fix plan:
  <https://github.com/djbclark/stayturgid/blob/master/docs/plans/outstanding-fix-priorities-2026-07-13.md>
