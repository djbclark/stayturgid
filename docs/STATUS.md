...
**Last verified:** 2026-07-23 (policy-doc follow-up completed; fleet/health
facts from earlier same day). Read this first; it links everywhere else. If a
...
| ------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Site discovery hardening** ([#48](https://github.com/djbclark/stayturgid/issues/48))                                                           | **Next on the stack**                                        | Exclude `site-private` from overlay discovery, add `~/ops/.mysite` fallback, announce resolved site dir, ensure `site-private` exists. Issue lists every doc to update when code lands. Three-way memory/docs policy split (2026-07-23) is **done** — see [session-2026-07-23-memory-policy-followup-plan.md](operations/sessions/session-2026-07-23-memory-policy-followup-plan.md).                                               |
