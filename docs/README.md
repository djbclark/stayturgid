...
| [plans/autojs6-to-native-apk-plan.md](operations/plans/autojs6-to-native-apk-plan.md)                       | AutoJs6 → Kotlin/Shizuku UserService APK migration (OPTIONS **K1**; plan only)                                                                     |
