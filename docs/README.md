...
| AutoJs6              | [docs/architecture/components/autojs6.md](architecture/components/autojs6.md)                           | JS watchdog (only automation stack in repo)                                          |
...
| [docs/handoff.md](handoff.md)                                                                               | AI agents / maintainers — **session start:** `just health`; **2026-07-10 reorg:** read Cold-start first; **[`docs/rules/`](rules/)** |
| [docs/coding-rules.md](coding-rules.md)                                                                     | Durable implementation, device-safety, test, Git, and done rules                                                                     |
| [`docs/rules/`](rules/)                                                                                     | Always-on AI agent rules (self-heal, screen-control hold, …) — **read on handoff**                                                   |
...
| [plans/outstanding-fix-priorities-2026-07-13.md](archive/plans/outstanding-fix-priorities-2026-07-13.md)    | Ordered reliability work + junior-agent resume prompt                                                                                |
| [plans/just-migration-plan.md](archive/plans/just-migration-plan.md)                                        | Staged GNU Make → `just` migration after reliability fixes                                                                           |
| [plans/autojs6-to-native-apk-plan.md](archive/plans/autojs6-to-native-apk-plan.md)                          | AutoJs6 → Kotlin/Shizuku UserService APK migration (OPTIONS **K1**)                                                                  |
| [plans/native-agent-status-2026-07-22.md](archive/plans/native-agent-status-2026-07-22.md)                  | K1 live status, fleet rollout matrix, remaining steps                                                                                |
| [handoffs/handoff-2026-07-23-native-agent-k1.md](operations/sessions/handoff-2026-07-23-native-agent-k1.md) | **Current** K1 native-agent handoff (post-cutover; what to do next)                                                                  |
| [handoffs/handoff-2026-07-22-native-agent-k1.md](archive/sessions/handoff-2026-07-22-native-agent-k1.md)    | Historical K1 dual-run handoff (superseded 2026-07-23)                                                                               |
...
| [docs/architecture/vlm.md](architecture/vlm.md)                                                             | UI-TARS vision gates                                                                                                                 |
