...
| [plans/outstanding-fix-priorities-2026-07-13.md](operations/plans/outstanding-fix-priorities-2026-07-13.md) | Ordered reliability work + junior-agent resume prompt                                                                                              |
| [plans/just-migration-plan.md](operations/plans/just-migration-plan.md)                                     | Staged GNU Make → `just` migration after reliability fixes                                                                                         |
| [plans/autojs6-to-native-apk-plan.md](operations/plans/autojs6-to-native-apk-plan.md)                       | AutoJs6 → Kotlin/Shizuku UserService APK migration (OPTIONS **K1**)                                                                                |
| [plans/native-agent-status-2026-07-22.md](operations/plans/native-agent-status-2026-07-22.md)               | K1 live status, fleet rollout matrix, remaining steps                                                                                              |
| [handoffs/handoff-2026-07-23-native-agent-k1.md](operations/handoffs/handoff-2026-07-23-native-agent-k1.md) | **Current** K1 native-agent handoff (post-cutover; what to do next)                                                                                |
| [handoffs/handoff-2026-07-22-native-agent-k1.md](operations/handoffs/handoff-2026-07-22-native-agent-k1.md) | Historical K1 dual-run handoff (superseded 2026-07-23)                                                                                             |
