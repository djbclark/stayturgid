...
| `fleet_health_monitor.py`              | Soft health scrape (watchdog/a11y/sshd/bootloop) → `fleet-health.log`; legacy watchdog/AutoJs6 a11y telemetry fields remain but no longer trigger repair |
