...
| --- | ------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------ |
| 1   | Private site overlay repo + access model          | **DECIDED 2026-07-18:** GitHub private `site-djbclark`, one repo for the whole site (stayturgid overlay + general machine management). Base-dir convention `~/ops` with sibling checkouts. See the site repo's `docs/plans/site-djbclark-step1-segmentation-architecture-v1.md`.                                  | Security, backup, CI           |
