...
Usage:
  ./mac/a11y_services.py backup <s24|p7a|hd8|serial>
  ./mac/a11y_services.py restore <s24|p7a|hd8|serial> [--profile|--backup|--merge]
  ./mac/a11y_services.py show <s24|p7a|hd8|serial>
"""
