...
Usage:
  python3 mac/fire_peer_help.py handsets-start --target IP:5555 [--port N]
  python3 mac/fire_peer_help.py shizuku-start --target IP:5555
  python3 mac/fire_peer_help.py ping --target IP:5555
