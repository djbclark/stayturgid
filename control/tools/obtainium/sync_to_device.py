...
CATALOGS = {
    "all": (REPO_ROOT / "catalogs" / "obtainium" / "stayturgid-apps.json", "stayturgid-obtainium-apps.json"),
    "autojs6": (REPO_ROOT / "catalogs" / "obtainium" / "autojs6-only.json", "stayturgid-obtainium-autojs6.json"),
}
